...
class TestNaiveVisualizationHook:
    ...
    def test_after_train_iter(self):
        ...
        gt_datasamples = BaseDataElement(metainfo=dict(img_norm_cfg=dict(
        ...
        gt_datasamples = BaseDataElement(metainfo=dict(scale=(10, 10),
                                                       pad_shape=(15, 15, 3),
                                                       ori_height=5,
                                                       ori_width=5,
                                                       img_path='tmp.jpg'))
        ...
        gt_datasamples = BaseDataElement(metainfo=dict(
        ...
        # test with only pad
        gt_datasamples = BaseDataElement(metainfo=dict(pad_shape=(15, 15, 3),
                                                       ori_height=5,
                                                       ori_width=5,
                                                       img_path='tmp.jpg'))
        pred_datasamples = [BaseDataElement()]
