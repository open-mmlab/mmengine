...
from mmengine.analysis.flop_count import FlopCountAnalysis
...
class TestJitModelAnalysis(TestCase):
    ...
    def test_shared_module(self) -> None:
        ...
        analyzer = (
            FlopCountAnalysis(model=model,
                              inputs=inputs).unsupported_ops_warnings(
