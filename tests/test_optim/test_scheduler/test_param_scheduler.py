...
class TestParameterScheduler(TestCase):
    ...
    def test_resume(self):
        ...
        with self.assertRaisesRegex(KeyError,
            ...
            StepParamScheduler(self.optimizer,
                               param_name='lr',
                               gamma=0.1,
                               step_size=3,
                               last_step=10)
        ...
        for epoch in range(5):
            ...
            if epoch == 4:
                break
            scheduler.step()
        scheduler2 = ExponentialParamScheduler(self.optimizer,
                                               param_name='lr',
                                               gamma=0.9,
                                               last_step=4)
    ...
    def test_scheduler_before_optim_warning(self):
        ...
        def call_sch_before_optim():
            scheduler = StepParamScheduler(self.optimizer,
                                           param_name='lr',
                                           gamma=0.1,
                                           step_size=3)
            scheduler.step()
    ...
    def test_effective_interval(self):
        ...
        scheduler = LinearParamScheduler(self.optimizer,
                                         param_name='lr',
    ...
    def test_multi_step_scheduler(self):
        ...
        scheduler = MultiStepParamScheduler(self.optimizer,
                                            param_name='lr',
                                            gamma=0.1,
                                            milestones=[2, 5, 9])
        self._test_scheduler_value(scheduler, targets, epochs)
    ...
    def test_constant_scheduler(self):
        ...
        scheduler = ConstantParamScheduler(self.optimizer,
                                           param_name='lr',
                                           factor=1.0 / 2,
                                           end=5)
        self._test_scheduler_value(scheduler, targets, epochs)
    ...
    def test_linear_scheduler(self):
        with self.assertRaises(ValueError):
            LinearParamScheduler(self.optimizer,
                                 param_name='lr',
                                 start_factor=10,
                                 end=900)
        with self.assertRaises(ValueError):
    ...
    def test_cos_anneal_scheduler(self):
        with self.assertRaises(AssertionError):
            CosineAnnealingParamScheduler(self.optimizer,
                                          param_name='lr',
                                          T_max=10,
                                          eta_min=0,
                                          eta_min_ratio=0.1)
        ...
        scheduler = CosineAnnealingParamScheduler(self.optimizer,
                                                  param_name='lr',
                                                  T_max=t,
                                                  eta_min=eta_min)
        self._test_scheduler_value(scheduler, targets, epochs)
    ...
    def test_poly_scheduler(self):
        ...
        scheduler = PolyParamScheduler(self.optimizer,
                                       param_name='lr',
                                       power=power,
                                       eta_min=min_lr,
                                       end=iters + 1)
    ...
    def test_cosine_restart_scheduler(self):
        with self.assertRaises(AssertionError):
            CosineRestartParamScheduler(self.optimizer,
                                        param_name='lr',
                                        periods=[4, 5],
        ...
        scheduler = CosineRestartParamScheduler(self.optimizer,
                                                param_name='lr',
                                                periods=[4, 5],
                                                restart_weights=[1, 0.5],
                                                eta_min=0)
    ...
    def test_reduce_on_plateau_scheduler(self):
        ...
        with self.assertRaises(ValueError):
            ReduceOnPlateauParamScheduler(self.optimizer,
                                          'lr',
                                          begin=10,
                                          end=5)
        with self.assertRaises(AssertionError):
        ...
        scheduler = ReduceOnPlateauParamScheduler(self.optimizer,
                                                  param_name='lr',
                                                  monitor='loss')
    ...
    def test_multi_step_scheduler_state_dict(self):
        self._check_scheduler_state_dict(
            lambda: MultiStepParamScheduler(self.optimizer,
                                            param_name='lr',
                                            gamma=0.1,
                                            milestones=[2, 5, 9]),
            lambda: MultiStepParamScheduler(self.optimizer,
    ...
    def test_cosine_scheduler_state_dict(self):
        epochs = 10
        eta_min = 1e-10
        self._check_scheduler_state_dict(lambda: CosineAnnealingParamScheduler(
    ...
    def test_linear_scheduler_state_dict(self):
        ...
        self._check_scheduler_state_dict(
            ...
            lambda: LinearParamScheduler(self.optimizer,
                                         param_name='lr',
                                         start_factor=0,
                                         end_factor=0.3),
            epochs=epochs)
    ...
    def test_cosine_restart_scheduler_state_dict(self):
        self._check_scheduler_state_dict(
            lambda: CosineRestartParamScheduler(self.optimizer,
                                                param_name='lr',
                                                periods=[4, 5],
                                                restart_weights=[1, 0.5],
                                                eta_min=0),
    ...
    def test_reduce_on_plateau_scheduler_state_dict(self):
        ...
        self._check_scheduler_state_dict(
            lambda: ReduceOnPlateauParamScheduler(self.optimizer,
                                                  param_name='lr',
                                                  monitor='loss',
                                                  rule='less',
                                                  factor=0.01,
    ...
    def test_multi_scheduler_without_overlap_linear_multi_step(self):
        ...
        scheduler1 = LinearParamScheduler(self.optimizer,
                                          param_name='lr',
                                          start_factor=1 / 2,
                                          begin=0,
                                          end=5)
        scheduler2 = MultiStepParamScheduler(self.optimizer,
                                             param_name='lr',
                                             gamma=0.1,
                                             milestones=[3, 6],
                                             begin=5,
    ...
    def test_multi_scheduler_without_overlap_exp_cosine(self):
        ...
        scheduler1 = ExponentialParamScheduler(self.optimizer,
                                               param_name='lr',
                                               gamma=0.9,
                                               begin=0,
                                               end=5)
        ...
        scheduler2 = CosineAnnealingParamScheduler(self.optimizer,
                                                   param_name='lr',
                                                   T_max=5,
                                                   eta_min=eta_min,
                                                   begin=5,
    ...
    def test_onecycle_scheduler(self):
        ...
        with self.assertRaises(ValueError):
            OneCycleParamScheduler(self.optimizer,
                                   param_name='lr',
                                   total_steps=-1)
