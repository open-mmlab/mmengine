...
def test_get_file_backend():
    ...
    uri = "petrel://your_bucket/img.png"
    backend4 = fileio.get_file_backend(uri=uri, backend_args=backend_args, enable_singleton=True)
    ...
    backend5 = fileio.get_file_backend(uri=uri, backend_args=backend_args, enable_singleton=True)
    ...
    backend6 = fileio.get_file_backend(uri=uri, backend_args=backend_args, enable_singleton=True)
    ...
    backend7 = fileio.get_file_backend(uri=uri, backend_args=backend_args, enable_singleton=False)
...
def test_list_dir_or_file():
    ...
    with build_temporary_directory() as tmp_dir:
        ...
        assert set(fileio.list_dir_or_file(tmp_dir)) == {"dir1", "dir2", "text1.txt", "text2.txt"}
        ...
        assert set(fileio.list_dir_or_file(tmp_dir, list_file=False)) == {"dir1", "dir2"}

        with pytest.raises(TypeError, match="`suffix` should be None when `list_dir` is True"):
            list(fileio.list_dir_or_file(tmp_dir, list_file=False, suffix=".txt"))

        # only list directories recursively
        assert set(fileio.list_dir_or_file(tmp_dir, list_file=False, recursive=True)) == {
            "dir1",
            "dir2",
            osp.join("dir2", "dir3"),
        }
        ...
        # only list files
        assert set(fileio.list_dir_or_file(tmp_dir, list_dir=False)) == {"text1.txt", "text2.txt"}

        # only list files recursively
        assert set(fileio.list_dir_or_file(tmp_dir, list_dir=False, recursive=True)) == {
            osp.join("dir1", "text3.txt"),
            osp.join("dir2", "dir3", "text4.txt"),
            osp.join("dir2", "img.jpg"),
            "text1.txt",
        ...
        assert set(fileio.list_dir_or_file(tmp_dir, list_dir=False, suffix=".txt")) == {"text1.txt", "text2.txt"}
        assert set(fileio.list_dir_or_file(tmp_dir, list_dir=False, suffix=(".txt", ".jpg"))) == {
            "text1.txt",
            "text2.txt",
        }

        with pytest.raises(TypeError, match="`suffix` must be a string or tuple of strings"):
            list(fileio.list_dir_or_file(tmp_dir, list_dir=False, suffix=[".txt", ".jpg"]))

        # only list files ending with suffix recursively
        assert set(fileio.list_dir_or_file(tmp_dir, list_dir=False, suffix=".txt", recursive=True)) == {
            osp.join("dir1", "text3.txt"),
            osp.join("dir2", "dir3", "text4.txt"),
            "text1.txt",
            "text2.txt",
        ...
        # only list files ending with suffix
        assert set(fileio.list_dir_or_file(tmp_dir, list_dir=False, suffix=(".txt", ".jpg"), recursive=True)) == {
            osp.join("dir1", "text3.txt"),
            osp.join("dir2", "dir3", "text4.txt"),
            osp.join("dir2", "img.jpg"),
            "text1.txt",
