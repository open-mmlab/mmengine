...
def test_get_config():
    ...
    cfg = get_config('mmdet::faster_rcnn/faster_rcnn_r50_fpn_1x_coco',
                     pretrained=True)
    get_config('mmpose::face/2d_kpt_sview_rgb_img/deeppose/wflw/res50_wflw_256x256')  # noqa E301
...
def test_get_model():
    # TODO compatible with downstream codebase.
    get_model('mmdet::faster_rcnn/faster_rcnn_r50_fpn_1x_coco',
              build_func_name='build_detector')
    get_model('mmpose::face/2d_kpt_sview_rgb_img/deeppose/wflw/res50_wflw_256x256',  # noqa E301
