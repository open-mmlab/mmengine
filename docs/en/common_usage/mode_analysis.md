# Count the calculation of Model and Parameter
...
For the definition of model calculation and parameter and more usage, please refer[Model Complexity Analysis](../advanced_tutorials/model_analysis.md)
