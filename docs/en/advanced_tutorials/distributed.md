...
- [launch](mmengine.dist.launch)：A function to launch distributed task. [distributed_training_launch.py.py](https://github.com/open-mmlab/mmengine/blob/main/examples/distributed_training_launch.py) can enable distributed very simple with the `launch` function.
