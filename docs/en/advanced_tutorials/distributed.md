...
- [launch](mmengine.dist.launch): Launch distributed task with single or multiple machines/GPU. [train.py](https://github.com/open-mmlab/mmengine/blob/main/examples/train.py) can enable distributed training simply with the `launch` function.
